  ...
  return <>
    ...
    {(project.measureType||"interior")==="interior"&&<>
      {showInterior&&floor&&room&&<div style={{...CARD,padding:"12px 14px"}}>
        ...
        />
        <RoomEditor room={room} onUpdate={upRoom} quoteMode={project.quoteMode} category={project.category}/>
      </div>}
    ...
    {(project.measureType||"interior")==="exterior"&&<div style={{...CARD,padding:"12px 14px"}}>
        ...
        <ExteriorModule elevations={project.exterior||defExterior()} onChange={v=>up(p=>({...p,exterior:v}))} config={project.exteriorConfig||defExteriorConfig()} onConfigChange={v=>up(p=>({...p,exteriorConfig:v}))} quoteMode={project.quoteMode}/>
      </div>}
